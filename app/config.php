...
$CONFIG = [
    ...
    'space_label_a' => env('SPACE_LABEL_A', 'PÄąĹ»lka A'),
    'space_label_b' => env('SPACE_LABEL_B', 'PÄąĹ»lka B'),
...
const CATEGORIES = ['MP', 'MD', 'SÄąËť', 'ÄąËťÄ‚Ë‡ci', 'Dorost', 'MuÄąÄľi', 'JinÄ‚Â©'];
...
function space_label(string $space): string {
    ...
    if ($space === 'HALF_A') {
        return (string) cfg('space_label_a', 'PÄąĹ»lka A');
    }
    if ($space === 'HALF_B') {
        return (string) cfg('space_label_b', 'PÄąĹ»lka B');
    }
    return $space;
}
